...
const BannerTemplate = () => (
  <div className="h-[60vh] md:h-[85vh] bg-secondary rounded-b-[50px] md:rounded-b-[100px] flex flex-col justify-center items-start section-padding gap-[25px] md:gap-[50px]">
